...
class RolesController extends AdminController
{
    ...
    protected function before_filter()
    {
        ...
        $this->permiso_model = new PermisoModel();
        
        // Configurar vista
        View::title('Gestión de Roles');
    }
    ...
    public function ver($id)
    {
        ...
        View::title('Detalles del Rol: ' . $rol['nombre']);
    }
    ...
    public function editar($id)
    {
        ...
        View::title('Editar Rol: ' . $rol['nombre']);
    ...
    public function eliminar($id)
    {
        ...
        $this->rol = $rol;
        View::title('Eliminar Rol: ' . $rol['nombre']);
    }
    ...
    public function permisos($id)
    {
        ...
        View::title('Asignar Permisos: ' . $rol['nombre']);
